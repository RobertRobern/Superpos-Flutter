...
import 'package:superpos/features/pos/presentation/widgets/cart_section.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: isLargeScreen
          ...
          : FloatingActionButton.extended(
              onPressed: () {
                showModalBottomSheet(
                  ...
                  builder: (context) => DraggableScrollableSheet(
                    ...
                    minChildSize: 0.5,
                    maxChildSize: 0.95,
                    builder: (_, controller) => const CartSection(),
                  ),
                );
              },
              icon: Badge(
              ...
              label: Text('KSh ${cart.total.toStringAsFixed(2)}'),
            ),
      body: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Expanded(
            child: isLargeScreen
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Left side with search, categories, and products
                      Expanded(
                        flex: 3,
                        child: Column(
                ...
                : Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      // Main content with search, categories, and products
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
